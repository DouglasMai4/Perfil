        ...
        <div class={styles.sectionContainer}>
          <section id="about" class={styles.section}>
            ...
            <p>
              ...
              Minha paixão pela areá começou desde cedo, quando o meu pai comprou o meu primeiro computador, quando eu tinha por volta dos 14 anos. Eu acredito que eu tenha pego a curiosidade de criança, onde eu queria desmontar os meu brinquedos para ver como funcionavam, isso me fez ter muita curiosidade de como um computador funcionava, do porque quando eu clicava duas vezes no ícone de um app, ele abria.
